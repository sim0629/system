...
int d_srcB = [
	D_icode in { IIADDL, IOPL, IRMMOVL, IMRMOVL  } : D_rB;
...
int d_dstE = [
	D_icode in { IIADDL, IRRMOVL, IIRMOVL, IOPL} : D_rB;
	D_icode in { IPUSHL, IPOPL, ICALL, IRET } : RESP;
...
int aluB = [
	E_icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		     IIADDL, IPUSHL, IRET, IPOPL } : E_valB;
...
bool set_cc = E_icode in { IIADDL, IOPL } &&
