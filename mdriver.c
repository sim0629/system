...
int main(int argc, char **argv)
{
    ...
    int student_check = 1;  /* If set, check student structure (reset by -a) */
	...
	case 't': /* Directory where the traces are located */
	    ...
	    break;
        case 'a': /* Don't check student structure */
            student_check = 0;
            break;
    ...
    /* 
     * Check and print studnet info 
     */
    if (student_check) {
	/* Students must fill in their student information */
...
static void usage(void) 
{
    ...
    fprintf(stderr, "\t-a         Don't check the student structure.\n");
